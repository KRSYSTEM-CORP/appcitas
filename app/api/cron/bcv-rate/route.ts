...
// FX-enabled VES business's exchange rate automatically. Vercel signs its
// own cron requests with `Authorization: Bearer $CRON_SECRET` once that env
// var is set on the project, which is what's checked below.
